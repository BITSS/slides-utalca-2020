...
date:  "`r format(as.Date('2020-10-15'), '%d %m %Y')` | [diapositivas](https://github.com/BITSS/ACREslides-utalca-2020)"
output: 
...
Un plan de pre-análisis (PAPs) es una descripción detallada de los análisis a ser conducidos. 
...
- Explication detallada de todo el conjunto de tests a llevar a cabo. 
